...
def load_one_date(date):
    ...
    unformed_content = tk_u.server_request(CONSTANTS.api_url_tail, unf_params)
    ...
    cities_df.to_csv(r"match_tables/cities_and_types.csv", sep=';', index=False)
    try:
    ...
    geo_content = tk_u.server_request(CONSTANTS.api_url_tail, geo_params)
    ...
    pin_content = tk_u.server_request(CONSTANTS.api_url_tail, pin_params)
    ...
    ord_content = tk_u.server_request(CONSTANTS.api_url_tail, ord_params)
